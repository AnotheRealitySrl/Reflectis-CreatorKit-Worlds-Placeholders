...
Shader "New Amplify Shader 3"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Maintexture1("Main texture", 2D) = "white" {}
		[ASEEnd][IntRange]_UVIndex1("UV Index", Range( 0 , 15)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult8 = (float2((0.0 + (_UVIndex1 - 0.0) * (0.94 - 0.0) / (15.0 - 0.0)) , 0.0));
				float2 texCoord9 = IN.ase_texcoord7.xy * float2( 1,1 ) + appendResult8;
				
				float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = tex2D( _Maintexture1, texCoord9 ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult8 = (float2((0.0 + (_UVIndex1 - 0.0) * (0.94 - 0.0) / (15.0 - 0.0)) , 0.0));
				float2 texCoord9 = IN.ase_texcoord2.xy * float2( 1,1 ) + appendResult8;
...
/*ASEBEGIN
Version=18712
1974;59;1920;873;1755.677;534.2338;1.404999;True;True
Node;AmplifyShaderEditor.RangedFloatNode;6;-1332.888,49.87634;Inherit;False;Property;_UVIndex1;UV Index;1;1;[IntRange];Create;True;0;0;0;False;0;False;0;3;0;15;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;7;-1044.888,64.87634;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;15;False;3;FLOAT;0;False;4;FLOAT;0.94;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;8;-756.8877,59.87634;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;9;-587.9882,7.076322;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-355.9885,-56.92368;Inherit;True;Property;_Maintexture1;Main texture;0;0;Create;True;0;0;0;False;0;False;-1;None;0f3b11011ff61074da7d2a2d7de79be6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader 3;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=EF5FA0BACFFFB334E3E9B940B7567658FB47BB0C