...
Shader "Custom/PBR Packed Emissive"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_ColorSmoothness("Color Smoothness", 2D) = "white" {}
		_NormalOcclusionMetallic("Normal Occlusion Metallic", 2D) = "bump" {}
		...
		[ASEEnd][HDR]_EmissionColor("Emission Color", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _ColorSmoothness_ST;
			float4 _Color;
			float4 _NormalOcclusionMetallic_ST;
			float4 _Emissive_ST;
			...
			sampler2D _ColorSmoothness;
			sampler2D _NormalOcclusionMetallic;
			sampler2D _Emissive;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_ColorSmoothness = IN.ase_texcoord8.xy * _ColorSmoothness_ST.xy + _ColorSmoothness_ST.zw;
				float4 BaseColor13 = ( tex2D( _ColorSmoothness, uv_ColorSmoothness ) * _Color );
				
				float2 uv_NormalOcclusionMetallic = IN.ase_texcoord8.xy * _NormalOcclusionMetallic_ST.xy + _NormalOcclusionMetallic_ST.zw;
				float4 tex2DNode23 = tex2D( _NormalOcclusionMetallic, uv_NormalOcclusionMetallic );
				float4 appendResult25 = (float4(tex2DNode23.r , tex2DNode23.g , 1.0 , 1.0));
				float3 Normal26 = UnpackNormalScale( appendResult25, 1.0 );
				
				float2 uv_Emissive = IN.ase_texcoord8.xy * _Emissive_ST.xy + _Emissive_ST.zw;
				float4 Emissive47 = ( tex2D( _Emissive, uv_Emissive ) * _EmissionColor );
				
				float Metallic32 = ( tex2D( _NormalOcclusionMetallic, uv_NormalOcclusionMetallic ).a * _Metallic );
				
				float Smoothness20 = ( tex2D( _ColorSmoothness, uv_ColorSmoothness ).a * _Roughness );
				
				float Occlusion38 = ( tex2D( _NormalOcclusionMetallic, uv_NormalOcclusionMetallic ).b + ( 1.0 - _Occlusion ) );
				

				float3 BaseColor = BaseColor13.rgb;
				float3 Normal = Normal26;
				float3 Emission = Emissive47.rgb;
				float3 Specular = 0.5;
				float Metallic = Metallic32;
				float Smoothness = Smoothness20;
				float Occlusion = Occlusion38;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_ColorSmoothness = IN.ase_texcoord2.xy * _ColorSmoothness_ST.xy + _ColorSmoothness_ST.zw;
				float4 BaseColor13 = ( tex2D( _ColorSmoothness, uv_ColorSmoothness ) * _Color );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_NormalOcclusionMetallic = IN.ase_texcoord4.xy * _NormalOcclusionMetallic_ST.xy + _NormalOcclusionMetallic_ST.zw;
				float4 tex2DNode23 = tex2D( _NormalOcclusionMetallic, uv_NormalOcclusionMetallic );
				float4 appendResult25 = (float4(tex2DNode23.r , tex2DNode23.g , 1.0 , 1.0));
				float3 Normal26 = UnpackNormalScale( appendResult25, 1.0 );
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.CommentaryNode;48;-2653.205,1870.085;Inherit;False;994.2013;474.6659;Comment;4;44;47;46;50;Emissive;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;41;-2642.579,1372.34;Inherit;False;951.5917;393.8269;Comment;5;36;35;39;40;38;Occlusion;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;33;-2645.114,863.9195;Inherit;False;950.4744;385.9999;Comment;4;29;30;31;32;Metallic;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;27;-2667.32,401.3185;Inherit;False;1170.06;366.594;Comment;4;25;23;24;26;Normal;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;14;-2677.763,-698.1019;Inherit;False;967.572;480.3933;Comment;4;11;10;12;13;Base Color ;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-2180.191,-554.7086;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;13;-1934.191,-521.7086;Inherit;False;BaseColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;16;-2677.005,-147.5013;Inherit;False;967.572;480.3933;Comment;4;20;18;17;21;Roughness ;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-2179.433,-4.108065;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-2627.763,-648.1019;Inherit;True;Property;_ColorSmoothness;Color Smoothness;0;0;Create;True;0;0;0;False;0;False;-1;None;2afc612dff1aa914490eb73a51c15c7e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;25;-2253.041,487.5167;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.UnpackScaleNormalNode;24;-1997.277,487.1459;Inherit;False;Tangent;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RegisterLocalVarNode;26;-1722.646,481.9405;Inherit;False;Normal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;20;-1962.595,15.81953;Inherit;False;Smoothness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;28;-216.5627,-222.7383;Inherit;False;26;Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;15;-217.2895,-314.5903;Inherit;False;13;BaseColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-2119.114,1007.919;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;32;-1918.64,1005.114;Inherit;False;Metallic;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;39;-2302.115,1655.167;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;29;-2596.414,916.5195;Inherit;True;Property;_NormalOcclusionMetallic1;Normal Occlusion Metallic;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;23;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;36;-2592.579,1421.04;Inherit;True;Property;_NormalOcclusionMetallic2;Normal Occlusion Metallic;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;23;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;18;-2627.005,-97.50133;Inherit;True;Property;_ColorRoughness1;Color Roughness;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;10;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;12;-2546.191,-429.7086;Inherit;False;Property;_Color;Color ;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.3867925,0.3867925,0.3867925,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;43;-2643.086,-974.4437;Inherit;False;Property;_Culling;Culling;6;1;[Enum];Create;True;0;1;Option1;0;1;UnityEngine.Rendering.CullMode;True;0;False;2;2;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-2577.114,1133.919;Inherit;False;Property;_Metallic;Metallic;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-2606.12,123.8535;Inherit;False;Property;_Roughness;Roughness;3;0;Create;True;0;0;0;False;0;False;0.5;0.17;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-2576.579,1646.34;Inherit;False;Property;_Occlusion;Occlusion;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;40;-2117.591,1526.327;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;38;-1914.987,1520.591;Inherit;False;Occlusion;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;44;-2603.205,1920.085;Inherit;True;Property;_Emissive;Emissive ;7;0;Create;True;0;0;0;False;0;False;-1;None;1298e97b808e0ed42a913dab4a516efd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;47;-1883.005,2006.025;Inherit;False;Emissive;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;42;-213.123,203.4743;Inherit;False;38;Occlusion;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;22;-223.7715,114.614;Inherit;False;20;Smoothness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;49;-227.6912,-80.78937;Inherit;False;47;Emissive;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;34;-229.7689,0.3526993;Inherit;False;32;Metallic;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;128.2,-131.4;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Custom/PBR Packed Emissive;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Culling;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;638227666443504051;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;0;638227666511526203;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;-2199.691,1997.21;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;46;-2578.671,2132.751;Inherit;False;Property;_EmissionColor;Emission Color;8;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;23;-2603.487,456.8516;Inherit;True;Property;_NormalOcclusionMetallic;Normal Occlusion Metallic;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=87BE5A2F7DCFA5FAC6BCB24F2BBAC96A76A444EF