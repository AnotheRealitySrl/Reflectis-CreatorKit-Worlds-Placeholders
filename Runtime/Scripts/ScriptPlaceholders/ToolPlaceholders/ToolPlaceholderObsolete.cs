...
namespace Virtuademy.CreatorKit.Worlds.Placeholders
{
    public class ToolPlaceholderObsolete : SpawnableHandlerPlaceholder
    {
        ...
        public List<ToolItemPlaceholderObsolete> inventoryItems; //list of the scriptable objects describing the inventory items
    ...
    public class ToolPlaceholderObsoleteEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            ToolPlaceholderObsolete inventoryPlaceholder = (ToolPlaceholderObsolete)target;
